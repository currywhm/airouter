export default {
    settings: {
      ...
      payment: {
        ...
        field_appCertPublicKey: 'App Public-Key Certificate',
        field_alipayCertPublicKey: 'Alipay Public-Key Certificate',
        field_alipayRootCert: 'Alipay Root Certificate',
        ...
        alipayCertificateModeHint: 'Alipay uses certificate mode only. Download appCertPublicKey_*.crt, alipayCertPublicKey_RSA2.crt, and alipayRootCert.crt from Alipay Open Platform and paste the complete certificate contents. Private Key must match the App ID.',
