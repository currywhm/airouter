export default {
  ...
  wallet: {
    overview: {
      ...
      subtitle: 'Top up once and pay for actual usage',
      availableBalance: 'Available balance',
      account: 'Account',
      noSubscription: 'No subscriptions; your balance does not expire'
    },
    checkin: {
      title: 'Daily check-in',
      claim: 'Claim reward',
      claimed: 'Claimed today',
      claimedHint: 'Come back tomorrow for another reward',
